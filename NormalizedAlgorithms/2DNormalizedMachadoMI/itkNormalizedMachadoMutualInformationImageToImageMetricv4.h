 ...
 *
 *=========================================================================*/
#ifndef itkNormalizedMachadoMutualInformationImageToImageMetricv4_h
#define itkNormalizedMachadoMutualInformationImageToImageMetricv4_h
...
class ITK_TEMPLATE_EXPORT NormalizedMachadoMutualInformationImageToImageMetricv4
  : public ImageToImageMetricv4<TFixedImage, TMovingImage, TVirtualImage, TInternalComputationValueType, TMetricTraits>
{
public:
  ITK_DISALLOW_COPY_AND_ASSIGN(NormalizedMachadoMutualInformationImageToImageMetricv4);

  /** Standard class type aliases. */
  using Self = NormalizedMachadoMutualInformationImageToImageMetricv4;
  using Superclass =
  ...
  itkTypeMacro(NormalizedMachadoMutualInformationImageToImageMetricv4, ImageToImageMetricv4);
  ...
  // Defining types, getters and setters for the q parameter:
...
protected:
  NormalizedMachadoMutualInformationImageToImageMetricv4();
  ~NormalizedMachadoMutualInformationImageToImageMetricv4() override = default;

  friend class NormalizedMachadoMutualInformationImageToImageMetricv4GetValueAndDerivativeThreader<
  ...
  friend class NormalizedMachadoMutualInformationImageToImageMetricv4GetValueAndDerivativeThreader<
    ...
    Superclass,
    Self>;
  using NormalizedMachadoMutualInformationDenseGetValueAndDerivativeThreaderType =
    NormalizedMachadoMutualInformationImageToImageMetricv4GetValueAndDerivativeThreader<
      ThreadedImageRegionPartitioner<Superclass::VirtualImageDimension>,
      Superclass,
      Self>;
  using NormalizedMachadoMutualInformationSparseGetValueAndDerivativeThreaderType =
    NormalizedMachadoMutualInformationImageToImageMetricv4GetValueAndDerivativeThreader<ThreadedIndexedContainerPartitioner,
                                                                             Superclass,
                                                                             Self>;
...
#  include "itkNormalizedMachadoMutualInformationImageToImageMetricv4.hxx"
#endif
